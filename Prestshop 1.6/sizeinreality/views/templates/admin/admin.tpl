<div class="panel">
    ...
    <div class="panel-body" style="border-bottom: 1px solid #dcdcdc;padding: 8px !important;">
        <a class="h3">Files</a>
        <button type="button" id="uploadFileButton" class="btn btn-success" data-toggle="modal" data-target="#fileModal" style="font-weight: 800; float:right;">
            <i class="fa fa-plus-circle fa-lg" aria-hidden="true"></i> Upload 3D File </button>
    </div>
    <br/>
    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="sizeInRealityTable">
        <thead>
            <tr>
                <th align="center">SNo</th>
                <th align="center">sizeinrealityid</th>
    ...
    <div id="fileModal" class="modal fade" role="dialog">
        ...
        <div class="modal-content">
            ...
            <form action="" method="post" enctype="multipart/form-data" id= "sizeInRealityForm">
                ...
                <div class="modal-footer">
                  <button type="button" name="sizeInRealitysubmit" id="sizeInRealitysubmit" class="btn btn-default btn-md">Save</button>
                </div>
            </form> 
