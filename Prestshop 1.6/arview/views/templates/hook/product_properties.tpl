...
<div id="product-images" class="panel product-tab">
    <div class="panel-heading tab"> Ar View </div>
            ...
            <div class="col-lg-9">
                <div class="form-group">
                    <div class="col-lg-12">
                        ...
                        <button type="button" name="arviewsubmit" id="arviewupload" class="btn btn-default">Upload</button>
    ...
    <div id="drawtable"> 
        ...
        <tbody >
            ...
            <td> <a style="cursor:pointer;" data-id=" {$sqldata.arviewid}" data-model="{$sqldata.file}" data-productid="{$sqldata.productid}" id="deleteAr">
